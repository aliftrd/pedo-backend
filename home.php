...
<body>
    ...
    <div class="modal fade" id="themes-info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Check out other nice themes by clicking <i class="material-icons"
                        style="font-size: 18px; vertical-align: middle; margin: 0 5px;">layers</i> button at the top
    ...
    <div class="lime-sidebar">
        <div class="lime-sidebar-inner slimscroll">
            <ul class="accordion-menu">
                ...
                <li>
                    <a href=""><i class="material-icons">apps</i>Components<i
                            class="material-icons has-sub-menu">keyboard_arrow_left</i></a>
                    <ul class="sub-menu">
                        <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a class="dropdown-item" href="logout.php"
                                    class="btn btn-danger btn-md float-right"><span
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="search-result-list article-search">
                        <li>
                            <p>Lorem ipsum dolor sit amet, consectetur <span class="search-input-value"></span>
                                adipiscing elit, sunt in culpa quifdaasd quis.</p>
                            <span class="search-article-date">06 Dec, 2018</span>
                        </li>
                        <li>
                            <p>Duis non semper sapien. Morbi imperdiet velit in <span class="search-input-value"></span>
                                bibendum lobortis. Integer arcu urna, elementum in pellentesque nec, finibus at nisi.
                            </p>
