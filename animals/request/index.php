...
$prev_page_url = $current_page < 2 ? null : base_url('animals/detail/index.php?page=' .  ($current_page - 1)); // Previous page link
$next_page_url = $current_page == $last_page ? null : base_url('animals/detail/index.php?page=' . ($current_page + 1)); // Next page link
